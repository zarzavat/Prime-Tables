...
var primeTableCalculator = new (require('../src/primeTableCalculator'))(primeGenerator);
...
describe('table output', function () {
    it('should generate correct 2x2 matrix', function (done) {
        primeTableCalculator.generateMatrix(1, function (err, matrix) {
    ...
    it('should have squared primes on the main diagonal', function (done) {
        primeTableCalculator.generateMatrix(10, function (err, matrix) {
            assert(matrix[0][0] === null);
